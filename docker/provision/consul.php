...
$_SERVER['CONSUL_HTTP_ADDR'] = 'http://' . $_SERVER['CONSUL_HTTP_ADDR'];
...
if (isset($_SERVER['SERVICE_KV_PATH'])) {
    array_push($search, '$SERVICE_KV_PATH$');
    array_push($replace, $_SERVER['SERVICE_KV_PATH']);
}
